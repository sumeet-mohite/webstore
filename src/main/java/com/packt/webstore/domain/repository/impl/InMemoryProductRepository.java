...
@Repository(value="InMemoryProductRepository")
public class InMemoryProductRepository //implements ProductRepository {
{
	...
	public InMemoryProductRepository() {
		...
		Product	iphone	=	new	Product("P1234","iPhone	5s",new	BigDecimal(500));
				...
				tablet_Nexus.setDescription("Google	Nexus7 is the lightest 7inch tablet	With a quad-core Qualcomm Snapdragon™ S4 Proprocessor");
